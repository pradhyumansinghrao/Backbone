...
public class UserPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(UserPost.this,LinearLayoutManager.VERTICAL, false);
    ...
    {
        final Intent i = new Intent(UserPost.this,PostDet.class);
        final Intent in = new Intent(UserPost.this,PostUserProfile.class);


        Query query = FirebaseDatabase.getInstance()
                .getReference()
                .child("post").orderByChild("uid").equalTo(uid);
        ...
        adapter = new FirebaseRecyclerAdapter<PostFace, PostViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final PostViewHolder holder, final int position, @NonNull final PostFace model) {
                ...
                if(model.privacy.equals("Private") | model.annonymously.equals("true"))
                {
